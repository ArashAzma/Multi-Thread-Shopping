...
userInfo* get_user_input(users* users_list) {
    ...
    /*
        ...
        if (strcmp(priceThresholdInput, "") == 0) priceThreshold = 10000;
    ...
    */
    ...
    // /*
        ...
        printf("please enter your price threshold: ");
        scanf("%d", &priceThreshold);
        if (priceThreshold == -1) priceThreshold = 10000;
    // */
